...
st.info(
    """
    ⚠️ **Atenção:** ao realizar pesquisas de mercado no **Mercado Livre**, lembre-se de que:
    
    - Cada **anúncio** representa uma **oferta individual**, e **não necessariamente um produto único**.  
    - Um mesmo **produto** pode aparecer em **diversos anúncios diferentes**, com variações de preço, título e vendedor.  
    - Portanto, para análises comparativas (preço, concorrência, posicionamento, etc.),  
      é essencial considerar essa **diferença entre “Produto” e “Anúncio”** para evitar interpretações incorretas dos dados.
    """,
    icon="ℹ️",
)
